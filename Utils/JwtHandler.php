...
//        $this->expire = $this->issuedAt + ConfigUtils::getInt("JWT_DURATION");
        $this->expire = (new \DateTime())->setTime(23,59,59)->getTimestamp()+1;

        // Passphrase à définir 
        $this->jwt_secrect = ConfigUtils::getProperty("JWT_SECRET");
    }
